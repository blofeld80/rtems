...
//
// ./scripts/prettyasserts.py -p LFS_ASSERT runners/test_runner.t.a.c -o runners/test_runner.t.c
//
...
#line 1 "runners/test_runner.t.a.c"
// Generated by ./scripts/test.py:
//
// ./scripts/test.py -c tests/test_alloc.toml tests/test_attrs.toml tests/test_badblocks.toml tests/test_bd.toml tests/test_compat.toml tests/test_dirs.toml tests/test_entries.toml tests/test_evil.toml tests/test_exhaustion.toml tests/test_files.toml tests/test_interspersed.toml tests/test_move.toml tests/test_orphans.toml tests/test_paths.toml tests/test_powerloss.toml tests/test_relocations.toml tests/test_seek.toml tests/test_superblocks.toml tests/test_truncate.toml -s runners/test_runner.c -o runners/test_runner.t.a.c
//

#include "runners/test_runner.h"

#line 1 "runners/test_runner.c"
/*
...
intmax_t test_define(size_t define) {
    ...
    fprintf(stderr, "error: undefined define %s (%zd)\n",
            name ? name : "(unknown)",
            define);
    __PRETTY_ASSERT_BOOL_EQ(false, true);
    exit(-1);
}
    ...
    if (test_trace_path) {
        ...
        if (!test_trace_file) {
            ...
            if (strcmp(test_trace_path, "-") == 0) {
                ...
                __PRETTY_ASSERT_BOOL_EQ(!err, true);
            }

            FILE *f = fdopen(fd, "a");
            __PRETTY_ASSERT_BOOL_EQ(f, true);
...
static void run_powerloss_cycles(
    ...
    while (true) {
        ...
        // power-loss!
        __PRETTY_ASSERT_INT_LE(i , cycle_count);
        printf("powerloss ");
        ...
        switch (c) {
            ...
            case OPT_DEFINE: {
                ...
                *sep = '\0';
                ...
                __PRETTY_ASSERT_INT_GT(override->permutations , 0);
                break;
