...
//
// ./scripts/prettyasserts.py -p LFS_ASSERT bd/lfs_emubd.t.a.c -o bd/lfs_emubd.t.c
//
...
#line 1 "bd/lfs_emubd.t.a.c"
// Generated by ./scripts/test.py:
//
// ./scripts/test.py -c tests/test_alloc.toml tests/test_attrs.toml tests/test_badblocks.toml tests/test_bd.toml tests/test_compat.toml tests/test_dirs.toml tests/test_entries.toml tests/test_evil.toml tests/test_exhaustion.toml tests/test_files.toml tests/test_interspersed.toml tests/test_move.toml tests/test_orphans.toml tests/test_paths.toml tests/test_powerloss.toml tests/test_relocations.toml tests/test_seek.toml tests/test_superblocks.toml tests/test_truncate.toml -s bd/lfs_emubd.c -o bd/lfs_emubd.t.a.c
//

#include "runners/test_runner.h"

#line 1 "bd/lfs_emubd.c"
/*
...
int lfs_emubd_prog(const struct lfs_config *cfg, lfs_block_t block,
    ...
    if (bd->cfg->erase_value != -1) {
        for (lfs_off_t i = 0; i < size; i++) {
            __PRETTY_ASSERT_INT_EQ(b->data[off+i] , bd->cfg->erase_value);
        }
    }
...
static int lfs_emubd_rawcrc(const struct lfs_config *cfg,
    ...
    __PRETTY_ASSERT_INT_LT(block , cfg->block_count);
